...
RANGES: List[Tuple[int, int, int, str, str]] = [
    ...
    (908667, 426, 529, "faura_linans", "r ken"),
    (908667, 530, 549, "minayo_(world_election)", "tenmaso"),

    (3448450, 1, 1030, "kururu_(world_election)", "mikagami mamizu"),
    (3448450, 1031, 1447, "sophia_usty", "tenmaso"),
    (3448450, 1448, 2000, "shishidou_iori", "ichikura robo"),

    (3448451, 1, 832, "parfil", "mikagami mamizu"),
    (3448451, 833, 1270, "faura_linans", "r ken"),
    (3448451, 1271, 1458, "minayo_(world_election)", "tenmaso"),
    (3448451, 1459, 2000, None, "ichikura robo"),

    (3448452, 1085, 1908, "kururu_(world_election)", "mikagami mamizu"),
    ...
    (793447, 196, 1049, "sakurai_mayura", "satasama"),
    (793447, 1129, 1156, "sakurai_mayura, tsuzuki_haruka", "satasama, mizuno sao"),
    (793447, 1234, 1418, "sakurai_mayura", "satasama"),
    ...
    (1537478, 121, 974, "sakurai_mayura", "satasama"),
    (1537478, 1050, 1077, "sakurai_mayura, tsuzuki_haruka", "satasama, mizuno sao"),
    (1537478, 1155, 1339, "sakurai_mayura", "satasama"),
    ...
    # Noble Butler
    (3328263, 96, 172, "luna_fleur_lenisphilia", "natsuki marina"),
    (3328263, 173, 257, "melty_fleur_lenisphilia", "mogupon"),
    (3328263, 258, 338, "tina_fleur_lenisphilia", "shiwasu horio"),

    (3328263, 401, 455, "luna_fleur_lenisphilia", "natsuki marina"),
    (3328263, 456, 513, "melty_fleur_lenisphilia", "mogupon"),
    (3328263, 514, 584, "tina_fleur_lenisphilia", "shiwasu horio"),
    ...
    (1838084, 2, 290, "bernadette_henrietta_eiselston", "arisue tsukasa"),
    (1838084, 291, 525, "anri_francis_la_bernard", "syroh"),
    (1838084, 526, 728, "sasara_orihime", "arisue tsukasa"),
    (1838084, 729, 916, "shirogama_naomi", "syroh"),
    (1988313, 2, 655, "anri_francis_la_bernard", "syroh"),
    (1988313, 656, 1150, "bernadette_henrietta_eiselston", "arisue tsukasa"),
    ...
    (1033787, 272, 540, "kokoro_judith", "2-g"),
    ...
    (1499212, 273, 541, "kokoro_judith", "2-g"),
    ...
    (1115664, 544, 804, "kokoro_judith", "2-g"),
    ...
    (1445367, 856, 1113, "ijuuin_kimika", "mikagami mamizu"),
    ...
    (3446914, 1, 664, "kimihara_yua", "mikagami mamizu"),
    (3446914, 665, 1344, "takanashi_tsumugi_(pieces)", "mikagami mamizu"),
    (3446915, 1, 714, "aino_miori", "mikagami mamizu"),
    (3446915, 715, 1460, "mishiro_arisu", "mikagami mamizu"),
    (3446916, 1, 264, "ijuuin_kimika", "mikagami mamizu"),
    (3446916, 441, 1168, "mishiro_arisu", "mikagami mamizu"),
    # Unless Terminalia
    ...
    (708634, 14, 157, "asagiri_nozomi", None),
    (708634, 158, 313, "asagiri_sakura", None),
    (708634, 314, 469, "electrichka_sapsan", None),
    (708634, 470, 589, "yakuouji_komachi", None),
    # Cocoro＠Function
    ...
    # Haze Man
    (1121739, 17, 94, "farah_perellies", "kyou"),
    (1121739, 110, 167, "miyadera_renka", "kyou"),
    (1121739, 171, 173, "miyadera_renka", "kyou"),
    (1121739, 209, 241, "farah_perellies, miyadera_renka", "kyou"),
    ...
    (1083084, 578, 685, "ame_(dal segno)", "takano yuki"),

    (1056040, 4, 49, "ame_(dal segno)", "takano yuki"),
    ...
    (1056040, 483, 486,"ame_(dal segno)", "takano yuki"),
    ...
    (929047, 4, 111, "ame_(dal segno)", "takano yuki"),
    ...
    (753612, 713, 1112, "tsukishiro_nami", "minakami rinka"),
    ...
    (1356727, 1314, 1713, "alisa_forerulozzo", "ichiyo moka"),
    (1356727, 1714, 2000, "yuel_yunietto", "suzunone rena"),
    (1356751, 1, 40, "yuel_yunietto", "suzunone rena"),
    (1356751, 42, 449, "liliana_echsun", "umetori uriri"),
    (1353705, 3, 259, "alisa_forerulozzo", "ichiyo moka"),
    (1353705, 260, 534, "yuel_yunietto", "suzunone rena"),
    ...
    (2710683, 275, 344, "emma_aaron_yakushiin", "chobipero"),
    ...
    (2410167, 661, 770, "emma_aaron_yakushiin", "chobipero"),
    ...
    (3103887, 615, 761, "emma_aaron_yakushiin", "chobipero"),
    ...
    (3720060, 625, 762, "emma_aaron_yakushiin", "chobipero"),
    ...
    (3984638, 2, 175, "kagome_(haison_shoujo)", "aiu"),
    (3984638, 176, 389, "yakumo_azusa", "yuurin"),
    (3984638, 390, 615, "kagami_shuri", "chobipero"),
    (3984638, 616, 762, "emma_aaron_yakushiin", "chobipero"),
    (3984638, 763, 873, "karasuno_tsubame", " "),
    (3984638, 874, 980, "furube_yurara", " "),
    (3984638, 981, 1097, "osakabe_rei", " "),
    (3984638, 1098, 1200, "yuzuriha_manaka", " "),

    (3987775, 2, 18, "kagome_(haison_shoujo)", "aiu"),
    (3987775, 19, 32, "yakumo_azusa", "yuurin"),
    (3987775, 33, 67, "kagami_shuri, yakumo_azusa", "chobipero, yuurin"),
    (3987775, 68, 89, "kagami_shuri", "chobipero"),
    (3987775, 90, 192, "emma_aaron_yakushiin", "chobipero"),
    (3987775, 193, 275, "karasuno_tsubame", " "),
    (3987775, 276, 303, "furube_yurara", " "),
    (3987775, 304, 329, "karasuno_tsubame, furube_yurara", " "),
    (3987775, 330, 343, "furube_yurara", " "),
    (3987775, 344, 374, "osakabe_rei, yuzuriha_manaka", " "),
    (3987775, 375, 421, "osakabe_rei", " "),
    (3987775, 422, 442, "osakabe_rei, yuzuriha_manaka", " "),
    (3987775, 443, 481, "yuzuriha_manaka", " "),
    (3987775, 482, 506, "osakabe_rei, yuzuriha_manaka", " "),

    (3215919, 1, 17, "kagome_(haison_shoujo)", "aiu"),
    (3215919, 18, 31, "yakumo_azusa", "yuurin"),
    (3215919, 32, 66, "kagami_shuri, yakumo_azusa", "chobipero, yuurin"),
    (3215919, 67, 88, "kagami_shuri", "chobipero"),
    (3215919, 89, 191, "emma_aaron_yakushiin", "chobipero"),
    (3215919, 192, 274, "karasuno_tsubame", " "),
    (3215919, 275, 302, "furube_yurara", " "),
    (3215919, 303, 328, "karasuno_tsubame, furube_yurara", " "),
    (3215919, 329, 342, "furube_yurara", " "),
    (3215919, 343, 373, "osakabe_rei, yuzuriha_manaka", " "),
    (3215919, 374, 420, "osakabe_rei", " "),
    (3215919, 421, 441, "osakabe_rei, yuzuriha_manaka", " "),
    (3215919, 442, 480, "yuzuriha_manaka", " "),
    (3215919, 481, 505, "osakabe_rei, yuzuriha_manaka", " "),

    (3717437, 1, 165, "kagome_(haison_shoujo)", "aiu"),

    (3987777, 1, 165, "kagome_(haison_shoujo)", "aiu"),
    ...
    (1414917, 422, 459, "beads_mcvitie", "kannagi rei"),
    (1414917, 842, 861, "sawa", "tanihara natsuki"),
    (970633, 5, 60, "nekoyashiki_maher", "kannagi rei"),
    (970633, 61, 120, "reina_lilou_lowchen", "kannagi rei"),
    (970633, 121, 175, "polina_mirovna_von_schwarzerhase", "kannagi rei"),
    (970633, 176, 226, "aiuchi_hiyoko", "kannagi rei"),
    (970633, 227, 260, "kamiya_eve", "kannagi rei"),
    ...
    (1333093, 1, 2000, "maja_krienke", "kannagi rei"),
    (1333084, 1, 2000, "maja_krienke", "kannagi rei"),
    ...
    (1354508, 315, 358, "suzakuin_miyako", "usume shirou"),
    ...
    (1359096, 315, 358, "suzakuin_miyako", "usume shirou"),
    ...
    (1011409, 579, 713, "miyama_momiji", "usume shirou"),
    ...
    # Traveling Stars
    (1001634, 1, 147, "zyrconia_silvatore", "matsushita makako"),

    (847945, 2, 58, "eliza_roses_crawford", "uonuma yuu"),
    (847945, 59, 205, "fin_shared", "takayaki"),
    (847945, 206, 381, "zyrconia_silvatore", "matsushita makako"),
    (847945, 382, 538, "eliza_roses_crawford", "uonuma yuu"),
    (847945, 539, 774, "chloe_de_plelune", "suzuhira hiro"),
    (847945, 775, 830, "rocco_misha", "naenae"),
    ...
    (3042610, 1, 1, "alfine_midir", "hiiragi ringo, nanotaro, mizuki yuuma"),
    (3042610, 490, 690, "alfine_midir", "hiiragi ringo"),
    (3042610, 2, 208, "lia", "nanotaro"),
    (3042610, 209, 489, "chloe_rouen", "mizuki yuuma"),
    (3042610, 691, 883, None, " "),
    (3435331, 78, 362, "lia", "nanotaro"),
    (3435331, 363, 562, "chloe_rouen", "mizuki yuuma"),
    (3435331, 563, 737, "alfine_midir", "hiiragi ringo"),
    (3435332, 1, 285, "lia", "nanotaro"),
    (3435332, 286, 485, "chloe_rouen", "mizuki yuuma"),
    (3435332, 486, 660, "alfine_midir", "hiiragi ringo"),
    ...
    (1122361, 168, 213, "orihime_nakajima_aster", "yukie"),
    ...
    (2284346, 80, 123, "berka_triade", "shiratama"),
    ...
    (2284346, 577, 623, "berka_triade", "shiratama"),
    (2284346, 624, 664, "mare_ashley-pecker", "shiratama"),
    (2284346, 665, 714, "ruby_(jewelry_hearts_academia)", "shiratama"),

    (2393258, 34, 79, "arianna_heartbell", "shiratama"),
    (2393258, 80, 123, "berka_triade", "shiratama"),
    (2393258, 124, 177, "mare_ashley-pecker", "shiratama"),
    (2393258, 178, 224, "ruby_(jewelry_hearts_academia)", "shiratama"),
    (2393258, 507, 551, "arianna_heartbell", "shiratama"),
    (2393258, 552, 598, "berka_triade", "shiratama"),
    (2393258, 599, 639, "mare_ashley-pecker", "shiratama"),
    (2393258, 640, 689, "ruby_(jewelry_hearts_academia)", "shiratama"),

    (2397624, 1, 282, "arianna_heartbell", "shiratama"),
    (2397624, 283, 690, "berka_triade", "shiratama"),
    ...
    (3255696, 22, 31, "berka_triade", "shiratama"),
    ...
    (3255696, 241, 269, "berka_triade", "shiratama"),
    (3255696, 270, 293, "mare_ashley-pecker", "shiratama"),
    (3255696, 294, 316, "ruby_(jewelry_hearts_academia)", "shiratama"),
    (3255696, 172, 185, "milia_meulendolff", "shiratama"),
    (3255696, 376, 417, "milia_meulendolff", "shiratama"),
    ...
    (932069, 2, 288, "himekawa_honami", "asami asami"),
    (932069, 289, 583, "ashiya_suzuka", "asami asami"),
    (932069, 584, 878, "kurashiki_azusa", "asami asami"),
    (932069, 879, 1153, "hayase_chitose", "asami asami"),

    (3987784, 2, 288, "himekawa_honami", "asami asami"),
    (3987784, 289, 583, "ashiya_suzuka", "asami asami"),
    (3987784, 584, 864, "kurashiki_azusa", "asami asami"),
    (3987784, 865, 887, "ashiya_suzuka", "asami asami"),
    (3987784, 888, 925, "kurashiki_azusa", "asami asami"),
    (3987784, 926, 1200, "hayase_chitose", "asami asami"),

    (874047, 1, 29, "himekawa_honami", "asami asami"),
    (829919, 9, 20, "ashiya_suzuka", "asami asami"),

    (1403169, 5, 32, "himekawa_honami", "asami asami"),
    (1403169, 33, 73, "ashiya_suzuka", "asami asami"),
    (1403169, 74, 100, "kurashiki_azusa", "asami asami"),
    (1403169, 101, 126, "hayase_chitose", "asami asami"),
    (1403169, 127, 131, "himekawa_honami", "asami asami"),
    (1403169, 132, 135, "ashiya_suzuka", "asami asami"),
    (1403169, 136, 140, "kurashiki_azusa", "asami asami"),
    (1403169, 141, 143, "hayase_chitose", "asami asami"),
    ...
    (1056055, 49, 249, "lunalight_baker", "nagayama yuunon"),
    # SPIRAL!!
    ...
    (1579777, 340, 402, "marrou_altwin", "taniyama-san"),
    (1579777, 403, 462, "sophia", "taniyama-san"),
    (1579777, 463, 520, "charlone_doran", "taniyama-san"),
    ...
    (1787981, 13, 62, "marrou_altwin", "taniyama-san"),
    (1787981, 63, 110, "charlone_doran", "taniyama-san"),
    # 1/1 Kareshi Kanojo
    ...
    # Happy Live Show Up!
    (1921952, 4, 323, "sofia_tulina", "bekotarou"),
    (1921952, 324, 526, "karentia_berrybell", "bekotarou"),
    (1921952, 527, 709, "roo_mao", "bekotarou"),
    ...
    (1491674, 322, 2000, None, "filter_invalid"),
    ...
    (1920161, 5, 403, "valmuda_lexsabruka", "hinata nao"),
    (1920161, 404, 664, "fiona_nezlick", "hinata nao"),
    (1920161, 665, 1017, "andrea_kuki-murakami", "hinata nao"),
    (1920161, 1018, 1347, "yupitel_maximus", "hinata nao"),
    (1920161, 1348, 1713, "eucalitto", "hinata nao"),
    (1920161, 1714, 1964, "clarissa_orbas", "hinata nao"),
    (1920162, 1, 139, "clarissa_orbas", "hinata nao"),
    (1920162, 140, 511, "musee_(sex_underworld_e_youkoso!)", "hinata nao"),

    (2390728, 2, 157, "valmuda_lexsabruka", "hinata nao"),
    (2390728, 158, 277, "fiona_nezlick", "hinata nao"),
    (2390728, 278, 433, "andrea_kuki-murakami", "hinata nao"),
    (2390728, 434, 509, "yupitel_maximus", "hinata nao"),
    (2390728, 510, 589, "eucalitto", "hinata nao"),
    (2390728, 590, 745, "clarissa_orbas", "hinata nao"),
    (2390728, 746, 877, "musee_(sex_underworld_e_youkoso!)", "hinata nao"),

    # Homerarete Nobiru SR Shoujo-tachi
    (3454190, 3, 243, "amatohara_hinomi ", "hinata nao"),
    (3454190, 244, 491, "kurabayashi_tsukuko ", "hinata nao"),
    (3454190, 492, 725, "ushiroku_mikari", "hinata nao"),
    (3454190, 738, 1000, "rokuten_neon", "hinata nao"),
    (3454190, 1258, 1282, "amatohara_hinomi ", "hinata nao"),
    (3454190, 1283, 1332, "kurabayashi_tsukuko ", "hinata nao"),
    (3454190, 1333, 1382, "ushiroku_mikari", "hinata nao"),
    (3454190, 1383, 1407, "rokuten_neon", "hinata nao"),
    # Imouto Paradise! 3
    ...
    (1246523, 30, 53, "maha_diggsbaum_bancroft", "hinata mutsuki"),
    (1246523, 54, 72, "inaishi_arisa", "sasahiro"),
    (1246523, 73, 88, "aeba_natsuki", "annie"),
    (1246523, 95, 168, "hanyuuin_yuzuha", "annie"),
    (1246523, 169, 243, "maha_diggsbaum_bancroft", "hinata mutsuki"),
    ...
    (1133865, 311, 415, "lianfest_scale", "hasune"),

    (1135121, 2, 218, "cereaneeg_crown", "hasune"),
    (1135121, 219, 478, "fatishion_swallow", "hasune"),
    (1135121, 479, 675, "lianfest_scale", "hasune"),
    ...
    # Namaiki JK Library
    (2232441, 2, 298, "sawatari_airi", "ichiyo moka"),
    (2232441, 299, 488, "toono_arisu", "watagashi yui"),
    (2232441, 489, 638, "himegishi_neneko", "usume shirou"),
    (2232441, 767, 2000, None, "filter_invalid"),
    # Tsumi Koi x 2/3
    (960350, 1, 5, "mizusawa_meguri, yumemi_reina", "ichiyo moka"),
    (960350, 6, 13, "yumemi_reina", "ichiyo moka"),
    (960350, 14, 17, "mizusawa_meguri", "ichiyo moka"),
    (960350, 18, 46, "yumemi_reina", "ichiyo moka"),
    (960350, 47, 100, "mizusawa_meguri", "ichiyo moka"),
    (960350, 101, 115, "yumemi_reina", "ichiyo moka"),
    (960350, 116, 166, "mizusawa_meguri", "ichiyo moka"),
    (960350, 167, 170, "yumemi_reina", "ichiyo moka"),
    (960350, 171, 171, "mizusawa_meguri, yumemi_reina", "ichiyo moka"),
    # Yuusha-sama...♥ Watashi to H Shimasen ka? ~Hime-sama to H o Shinai to Derarenai Dungeon ni Tojikomerareta Ken ni Tsuite~
    (3144904, 12, 12, None, "filter_invalid"),
    (3144904, 73, 77, None, "filter_invalid"),
    (3144904, 87, 92, None, "filter_invalid"),
    (3144904, 177, 178, None, "filter_invalid"),
    (3144904, 210, 212, None, "filter_invalid"),
    (3144904, 224, 228, None, "filter_invalid"),
    (3144904, 232, 235, None, "filter_invalid"),
    (3144904, 273, 277, None, "filter_invalid"),
    (3144904, 294, 296, None, "filter_invalid"),
    (3144904, 341, 344, None, "filter_invalid"),
    (3144904, 366, 367, None, "filter_invalid"),
    (3144904, 421, 699, None, "filter_invalid"),
    (3144904, 1188, 1314, None, "filter_invalid"),
    (3144904, 1, 21, "himesama_(usume_shirou)", "usume shirou"),
    (3144904, 59, 249, "himesama_(usume_shirou)", "usume shirou"),
    (3144904, 278, 2000, "himesama_(usume_shirou)", "usume shirou"),
    # Ero Imo Hurricane!
    (1264152, 4, 18, "nanasaka_sakura", "usume shirou"),
    (1264152, 19, 39, "nanasaka_sakura, shijou_satsuki", "usume shirou"),
    (1264152, 40,  76, "nanasaka_sakura", "usume shirou"),
    (1264152, 77,  127, "nanasaka_sakura, shijou_satsuki", "usume shirou"),
    (1264152, 128, 167, "nanasaka_sakura", "usume shirou"),
    (1264152, 168,  170, "nanasaka_sakura, shijou_satsuki", "usume shirou"),
    (1264152, 172, 435, "nanasaka_sakura", "usume shirou"),
    (1264152, 436, 479, "shijou_satsuki", "usume shirou"),

    (1333075, 1, 2, "nanasaka_sakura, shijou_satsuki, shijou_sumire", "usume shirou"),
    (1333075, 3, 14, "nanasaka_sakura, shijou_satsuki", "usume shirou"),
    (1333075, 15, 18, "nanasaka_sakura", "usume shirou"),
    (1333075, 19, 20, "shijou_satsuki", "usume shirou"),
    (1333075, 21, 21, "shijou_sumire", "usume shirou"),
    (1333075, 22, 47, "nanasaka_sakura", "usume shirou"),
    (1333075, 48, 108, "nanasaka_sakura, shijou_satsuki", "usume shirou"),
    (1333075, 109, 171, "shijou_sumire", "usume shirou"),
    (1333075, 172, 174, "nanasaka_sakura, shijou_satsuki", "usume shirou"),
    (1333075, 176, 177, "nanasaka_sakura, shijou_satsuki, shijou_sumire", "usume shirou"),
    (1333075, 178, 215, "shijou_satsuki", "usume shirou"),
    (1333075, 216, 223, "nanasaka_sakura, shijou_satsuki, shijou_sumire", "usume shirou"),
    (1333075, 224, 276, "nanasaka_sakura", "usume shirou"),
    (1333075, 277, 388, "nanasaka_sakura, shijou_satsuki, shijou_sumire", "usume shirou"),

    (1404456, 1, 1, "nanasaka_sakura, shijou_satsuki, shijou_sumire", "usume shirou"),
    (1404456, 3, 32, "nanasaka_sakura, shijou_satsuki, shijou_sumire", "usume shirou"),
    (1404456, 33, 34, "nanasaka_sakura", "usume shirou"),
    (1404456, 35, 51, "nanasaka_sakura, shijou_satsuki, shijou_sumire", "usume shirou"),
    (1404456, 52, 96, "nanasaka_sakura", "usume shirou"),
    (1404456, 97, 133, "shijou_sumire", "usume shirou"),
    (1404456, 134, 175, "shijou_satsuki", "usume shirou"),
    (1404456, 176, 183, "nanasaka_sakura, shijou_satsuki, shijou_sumire", "usume shirou"),
    (1404456, 184, 200, "nanasaka_sakura, shijou_satsuki", "usume shirou"),
    (1404456, 201, 204, "nanasaka_sakura", "usume shirou"),
    (1404456, 205, 206, "shijou_satsuki", "usume shirou"),
    (1404456, 207, 209, "shijou_sumire", "usume shirou"),
    (1404456, 210, 271, "nanasaka_sakura, shijou_satsuki, shijou_sumire", "usume shirou"),
    (1404456, 272, 287, "shijou_satsuki", "usume shirou"),
    (1404456, 288, 307, "nanasaka_sakura, shijou_satsuki, shijou_sumire", "usume shirou"),
    (1404456, 308, 309, "nanasaka_sakura", "usume shirou"),
    (1404456, 310, 343, "nanasaka_sakura, shijou_satsuki, shijou_sumire", "usume shirou"),

    (1408985, 1, 440, "nanasaka_sakura", "usume shirou"),
    (1408985, 441, 616, "shijou_satsuki", "usume shirou"),
    (1408985, 617, 836, "shijou_sumire", "usume shirou"),
    (1408985, 859, 1298, "nanasaka_sakura", "usume shirou"),
    (1408985, 1299, 1474, "shijou_satsuki", "usume shirou"),
    (1408985, 1475, 1694, "shijou_sumire", "usume shirou"),

    (1408992, 1, 440, "nanasaka_sakura", "usume shirou"),
    (1408992, 441, 616, "shijou_satsuki", "usume shirou"),
    (1408992, 617, 836, "shijou_sumire", "usume shirou"),
    ...
    (893016, 219, 455, "amagase_yuuki", "iizuki tasuku"),
    (893016, 456, 650, "inubousaki_aya", "iizuki tasuku"),
    (893016, 651, 841, "tsukioka_misasa", "iizuki tasuku"),
    (893016, 842, 1141, "kurokawa_sera", "iizuki tasuku"),

    (801196, 13, 309, "nanasawa_yuni", "iizuki tasuku"),
    (801196, 310, 642, "amagase_yuuki", "iizuki tasuku"),
    (801196, 643, 930, "inubousaki_aya", "iizuki tasuku"),
    (801196, 931, 1190, "tsukioka_misasa", "iizuki tasuku"),
    (801196, 1191, 1628, "kurokawa_sera", "iizuki tasuku"),

    (665437, 2, 298, "nanasawa_yuni", "iizuki tasuku"),
    (665437, 299, 631, "amagase_yuuki", "iizuki tasuku"),
    (665437, 632, 919, "inubousaki_aya", "iizuki tasuku"),
    (665437, 920, 1179, "tsukioka_misasa", "iizuki tasuku"),
    (665437, 1180, 1617, "kurokawa_sera", "iizuki tasuku"),

    (1418640, 1, 612, "nanasawa_yuni", "iizuki tasuku"),
    (1418640, 613, 1219, "amagase_yuuki", "iizuki tasuku"),
    (1418640, 1220, 2000, "inubousaki_aya", "iizuki tasuku"),
    (1419015, 1, 665, "tsukioka_misasa", "iizuki tasuku"),
    (1419015, 666, 2000, "kurokawa_sera", "iizuki tasuku"),
    # lovely_x_cation 2
    (634660, 2, 261, "narukawa_hime", "iizuki tasuku"),
    (634660, 262, 573, "nirasaki_hinata", "iizuki tasuku"),
    (634660, 574, 811, "yoshinoya_seine", "iizuki tasuku"),
    (634660, 812, 1098, "izumi_wakoto", "iizuki tasuku"),

    (668043, 2, 305, "narukawa_hime", "iizuki tasuku"),
    (668043, 306, 515, "nirasaki_hinata", "iizuki tasuku"),
    (668043, 516, 715, "yoshinoya_seine", "iizuki tasuku"),
    (668043, 716, 917, "izumi_wakoto", "iizuki tasuku"),

    (1383295, 1, 1380, "narukawa_hime", "iizuki tasuku"),
    (1383295, 1381, 2000, "nirasaki_hinata", "iizuki tasuku"),
    (1383313, 1, 500, "nirasaki_hinata", "iizuki tasuku"),
    (1383313, 501, 1564, "yoshinoya_seine", "iizuki tasuku"),
    (1383313, 1565, 2000, "izumi_wakoto", "iizuki tasuku"),
    (1383327, 1, 509, "izumi_wakoto", "iizuki tasuku"),
    # Kemonomichi ☆ Girlish Square
    (2048155, 4, 57, "sumeragi_haneru", "shiromochi sakura"),
    (2048155, 58, 111, "nitani_tetora", "shiromochi sakura"),

    (2273091, 3, 38, "sumeragi_haneru", "shiromochi sakura"),
    (2273091, 39, 65, "nitani_tetora", "shiromochi sakura"),

    (2297808, 2, 55, "sumeragi_haneru", "shiromochi sakura"),
    (2297808, 56, 109, "nitani_tetora", "shiromochi sakura"),

    (2509128, 4, 33, "sumeragi_haneru", "shiromochi sakura"),
    (2509128, 34, 65, "nitani_tetora", "shiromochi sakura"),
    (2509128, 66, 134, "uduki_shirayuki", "shiromochi sakura"),
    (2509128, 135, 198, "morino_kumi", "shiromochi sakura"),

    (2770792, 3, 32, "sumeragi_haneru", "shiromochi sakura"),
    (2770792, 33, 64, "nitani_tetora", "shiromochi sakura"),
    (2770792, 65, 133, "uduki_shirayuki", "shiromochi sakura"),
    (2770792, 134, 197, "morino_kumi", "shiromochi sakura"),

    (3446853, 1, 264, "sumeragi_haneru", "shiromochi sakura"),
    (3446853, 265, 528, "nitani_tetora", "shiromochi sakura"),
    (3446853, 529, 880, "uduki_shirayuki", "shiromochi sakura"),
    (3446853, 881, 1232, "morino_kumi", "shiromochi sakura"),
    # Relirium - Iseki to Deai to Bouken to
    (3960937, 10 ,158, "hanamori_towa", "mikagami mamizu"),
    (3960937, 159, 275, "lisette_albert", "mikagami mamizu"),
    (3960937, 276, 405, "nanami_nagi", "mikagami mamizu"),
    (3960937, 406, 558, "kaguya_(relirium)", "mikagami mamizu"),
    (3960937, 559, 586, "oomatsu_hagumi", "mikagami mamizu"),
    (3960937, 587, 619, "sakuramachi_hotaru", "mikagami mamizu"),
    (3960937, 620, 663, "school_principal_(relirium)", "mikagami mamizu"),
    (3960937, 665, 1353, None, "filter_invalid"),
    (3960937, 1354, 1370, "hanamori_towa", "mikagami mamizu"),
    (3960937, 1371, 1385, "lisette_albert", "mikagami mamizu"),
    (3960937, 1386, 1396, "nanami_nagi", "mikagami mamizu"),
    (3960937, 1397, 1413, "kaguya_(relirium)", "mikagami mamizu"),
    (3960937, 1414, 1422, "oomatsu_hagumi", "mikagami mamizu"),
    (3960937, 1423, 1428, "sakuramachi_hotaru", "mikagami mamizu"),
    (3960937, 1429, 1432, "school_principal_(relirium)", "mikagami mamizu"),

    (3965497, 1, 1056, "hanamori_towa", "mikagami mamizu"),
    (3965497, 1057, 2000, "lisette_albert", "mikagami mamizu"),
    (3965498, 1, 632, "nanami_nagi", "mikagami mamizu"),
    (3965498, 633, 2000, "kaguya_(relirium)", "mikagami mamizu"),
    (3965499, 1, 576, "oomatsu_hagumi", "mikagami mamizu"),
    (3965499, 577, 936, "sakuramachi_hotaru", "mikagami mamizu"),
    (3965499, 937, 1192, "school_principal_(relirium)", "mikagami mamizu"),
    # Triple Pairing
    (3961392, 3, 802, "hoshi_eimi", "k-ko"),
    (3961392, 803, 1578, "chijiwa_nono", "mango pudding"),
    (3961392, 1579, 2000, "ootorimine_nazca", "k-ko"),
    (3961355, 1, 290, "ootorimine_nazca", "k-ko"),
    ...
    # Mosaic no Tenshi
    (4012242, 15, 283, "ibuki_hina, utsuka_haru", "mutou kurihito"),
    (4012242, 284, 2000, "ibuki_hina", "mutou kurihito"),
    (4012243, 1, 86, "ibuki_hina", "mutou kurihito"),
