...
RANGES: List[Tuple[int, int, int, str, str]] = [
    ...
    (2746430, 75, 129, "kohana (amairo chocolata)", "korie riko"),
    (2746430, 145, 154, "kohana (amairo chocolata)", "korie riko"),
    ...
    (1562101, 4, 49, None, "korie riko"),
    (1562101, 50, 89, "yukimura chieri", "shiratama"),
    (1562101, 107, 154, None, "korie riko"),
    (1562101, 155, 196, "yukimura chieri", "shiratama"),
    (2789734, 1, 473 , None, "korie riko"),
    (2789734, 474, 873 , "momose mitsuki", "shiratama"),
    # Koi Kakeru Shinai Kanojo
    ...
    (2872360, 145, 259, None, "yuuki rika"),
    ...
    (2893244, 1, 2000, "otome_kokoro", "yuuki rika"),
    (2893247, 1, 2000, "yuugure_tokoyo", "fuyuichi monme"),
    (2893248, 1, 1415, None, "yuuki rika"),
    # Futamata Ren'ai
    ...
    # Renai x Royale
    (1786483, 6, 272, None, "fuyuichi monme"),
    (1786483, 273, 400, None, "yuunagi seshina"),
    (1786483, 401, 545, "amagamine_renna", "yuuki rika"),
    (1786483, 573, 590, "iyori ao", "yuuki rika"),
    (1786483, 608, 671, "kagaya_yuna", "yuuki rika"),
    (1813072, 4, 1550, None, "fuyuichi monme"),
    (1813072, 1551, 2000, None, "yuunagi seshina"),
    (1813075,  1, 372, None, "yuunagi seshina"),
